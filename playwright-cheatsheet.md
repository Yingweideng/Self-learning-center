Playwright 命令手册（Cheat Sheet）

适用版本：Playwright 1.40+
涵盖语言：Node.js (JavaScript) 与 Python
分类：页面导航 / 页面内容 / 页面动作 / 元素内容 / 元素动作 / 断言

目录

一、页面导航 (Page Navigation)
二、页面内容 (Page Content)
三、页面动作 (Page Actions)
四、元素内容 (Element Content)
五、元素动作 (Element Actions)
六、断言 (Assertions)
